$(document).ready(function(){
    ...
    $(".cliente-excluir").on("click", function(){

        var url     = BASE_URL + "MyCode/functions/client/excluir";
        var title   = "Cliente: " + $(this).parent().parent().find(".name").html();
        var id      = $(this).parent().parent().attr("idCliente");
